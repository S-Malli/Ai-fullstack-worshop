...
export default function WhatsAppButton() {
  ...
  const queriesUrl = `https://wa.me/${whatsappNumber}?text=${message}`;
  const groupUrl = 'https://chat.whatsapp.com/LZt4akjoY7FByukfncLzQH';
    ...
    <div className="whatsapp-buttons-container">
      ...
      <a
        ...
        style={{
          ...
          animation: 'slide-in-bottom 0.6s var(--ease-out-expo)'
        }}
